...
static struct PyModuleDef moduledef = {
	...
	"Transcrypt.Crypto." _MODULE_STRING,
	NULL,
	-1,
	modulemethods,
	NULL,
...
_MODULE_NAME (void)
{
...
#else
	m = Py_InitModule("Transcrypt.Crypto." _MODULE_STRING, modulemethods);
#endif
	if (m == NULL)
		goto errout;
	...
	_counter_module = PyImport_ImportModule("Transcrypt.Crypto._counter");
	...
	{
		PyErr_SetString(PyExc_ImportError, "Crypto._counter ABI mismatch.  Was PyCrypto incorrectly compiled?");
		goto errout;
	}
