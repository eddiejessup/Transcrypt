...
from Transcrypt.Crypto import Counter
from Transcrypt.Crypto.strxor import strxor
from Transcrypt.Crypto.number import long_to_bytes, bytes_to_long
import Transcrypt.Crypto.Counter
from Transcrypt.Crypto import CMAC
from Transcrypt.Crypto.CMAC import _SmoothMAC
from Transcrypt.Crypto.KDF import _S2V
from Transcrypt.Crypto import galois
...
class BlockAlgo:
    ...
    def _start_eax(self, factory, key, *args, **kwargs):
        ...
        counter_obj = Transcrypt.Crypto.Counter.new(
            self.block_size * 8,
