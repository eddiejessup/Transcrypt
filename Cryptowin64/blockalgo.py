...
from Transcrypt.Cryptowin64 import Counter
from Transcrypt.Cryptowin64.strxor import strxor
from Transcrypt.Cryptowin64.number import long_to_bytes, bytes_to_long
import Transcrypt.Cryptowin64.Counter
from Transcrypt.Cryptowin64 import CMAC
from Transcrypt.Cryptowin64.CMAC import _SmoothMAC
from Transcrypt.Cryptowin64.KDF import _S2V
from Transcrypt.Cryptowin64 import galois
...
class BlockAlgo:
    ...
    def _start_eax(self, factory, key, *args, **kwargs):
        ...
        counter_obj = Transcrypt.Cryptowin64.Counter.new(
            self.block_size * 8,
